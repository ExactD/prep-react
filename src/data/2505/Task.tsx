...
const tasks = [
    {
      text: '1У паралелограмі \\(\\textit{ABCD}\\) діагональ BD утворює із сторонами \\(\\textit{BC}\\) і \\(\\textit{CD}\\) кути \\(57^{\\circ}\\) і \\(65^{\\circ}\\) (див. рисунок). Визначте градусну міру кута \\(\\textit{ABC}\\).',
      image: image_1805_1,
      variants: [
