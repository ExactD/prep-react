...
import image_2505_2 from '../../image/2505-2.jpg';
import image_2505_3 from '../../image/2505-3.jpg';
import image_2505_6 from '../../image/2505-6.jpg';
import image_2505_13 from '../../image/2505-13.jpg';
import image_2505_16 from '../../image/2505-16.jpg';
import image_2505_17 from '../../image/2505-17.jpg';
import image_2505_18 from '../../image/2505-18.jpg';
import image_2505_20 from '../../image/2505-20.jpg';

const tasks = [
  {
    text: 'Обчисліть \\(\\left(\\frac{5}{2}\\right)^2\\).<br><br>',
    image: null,
    variants: [
      { text: '\\(3,5\\)', image: null },
  ...
  {
    text: 'Точка \\(A\\) розташована всередині сфери з центром у точці \\(O\\). Укажіть найменше можливе значення діаметра цієї сфери, якщо \\(OA = 6\\).<br><br>',
    image: null,
    variants: [
      { text: '\\(15\\)', image: null },
      { text: '\\(7\\)', image: null },
  ...
  {
    text: 'Розв\'яжіть рівняння \\(\\frac{3x}{x-2} = 0\\).<br><br>',
    image: null,
    variants: [
      { text: '\\(3\\)', image: null },
      { text: '\\(2\\)', image: null },
  ...
  {
    text: 'У магазині одягу всі футболки коштують \\(300\\) \\(грн\\). У магазині діє акція: отримай знижку на одиницю другого товару. Скільки гривень має заплатити покупець за дві такі футболки разом, якщо за умовами акції за другу футболку він має заплатити на \\(40\\)% менше?<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Які з наведених тверджень є правильними?<br><br>I. Існує ромб, діагональ якого дорівнює сумі двох протилежних сторін.<br>II. Існує ромб, сума протилежних кутів якого дорівнює \\( 20^{\\circ} \\).<br>III. Існує ромб, діагональ якого ділить його на два правильні трикутники.<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Визначте об\'єм конуса, твірна якого дорівнює \\(13\\) \\(см\\), а висота - \\(12\\) \\(см\\).<br><br>',
    image: null,
    variants: [
      { text: '\\(156\\pi\\) \\(см^3\\)', image: null },
      { text: '\\(325\\pi\\) \\(см^3\\)', image: null },
      { text: '\\(100\\pi\\) \\(см^3\\)', image: null },
      { text: '\\(60\\pi\\) \\(см^3\\)', image: null },
      { text: '\\(300\\pi\\) \\(см^3\\)', image: null }
    ],
    variantImage: testImage
  },
  {
    text: 'Розкладіть на множники \\(x^2 - 6x + 5\\).<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Укажіть проміжок, якому належить корінь рівняння \\(5^{3x} \\cdot 5^{-2x} = \\frac{1}{5}\\).<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Укажіть проміжок, якому належить значення виразу \\(\\sqrt{5} \\cdot \\sqrt{6}\\).<br><br>',
    image: null,
    variants: [
      { text: '(\\(0\\); \\(2\\)]', image: null },
      { text: '(\\(2\\); \\(4\\)]', image: null },
  ...
  },
  {
    ...
    image: image_2505_13,
    variants: [
      { text: '\\(\\frac{4b}{11\\cos\\alpha}\\)', image: null },
  ...
  {
    text: 'Розв\'яжіть систему нерівностей \\(\\begin{cases} x^2 + 4 \\geq 0 \\\\ 2(3x - 5) - 6 < x + 8 \\end{cases}\\)<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'У геометричній прогресії \\((b_n)\\) відомо, що \\(b_3 = 24\\), \\(b_4 = 12\\). Визначте перший член \\(b_1\\) цієї прогресії.<br><br>',
    image: null,
    variants: [
      { text: '\\(36\\)', image: null },
      { text: '\\(48\\)', image: null },
  ...
  {
    text: 'Визначте кількість усіх від\'ємних цілих значень \\(a\\), за кожного з яких рівняння \\((\\sqrt{4x - 2a - 4} - 3) \\cdot (\\lg^2 x + 1) = 0\\) має корінь.',
    type: 'input',
    image: null,
  },
];
