...
const tasks = [
  ...
  {
    text: 'Розв\'яжіть рівняння \\(\\frac{3x}{x-2} = 0\\).',
    image: null,
    variants: [
      { text: '\\(3\\)', image: null },
      { text: '\\(2\\)', image: null },
  ...
  {
    text: 'Які з наведених тверджень є правильними?<br><br>I. Існує ромб, діагональ якого дорівнює сумі двох протилежних сторін.<br>II. Існує ромб, сума протилежних кутів якого дорівнює \\( 20^{\\circ} \\).<br>III. Існує ромб, діагональ якого ділить його на два правильні трикутники.',
    image: null,
    variants: [
