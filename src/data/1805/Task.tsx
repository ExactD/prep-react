...
import image_1805_9_1 from '../../image/1805-9-1.jpg';
import image_1805_9_2 from '../../image/1805-9-2.jpg';
import image_1805_9_3 from '../../image/1805-9-3.jpg';
import image_1805_9_4 from '../../image/1805-9-4.jpg';
import image_1805_9_5 from '../../image/1805-9-5.jpg';
...
const tasks = [
  ...
  {
    text: 'Доберіть закінчення речення так, щоб утворилося правильне твердження: «Висота конуса та його твірна лежать на прямих, що...<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Знайдіть значення виразу \\(\\frac{1}{3}m+\\frac{1}{5}n\\), якщо \\(m=-18\\), \\(n=55\\).<br><br>',
    image: null,
    variants: [
      { text: '\\(-5\\)', image: null },
      { text: '\\(-17\\)', image: null },
  ...
  {
    text: 'Ціна акції компанії зросла на \\(600\\) \\(грн\\), що становить \\(5\\)% від її початкової ціни.Якою була початкова ціна акції?<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Які з наведених тверджень є правильними? <br><br>I. Існує трапеція, у якої одна з бічних сторін перпендикулярна до її основ.<br>II. Існує трапеція, у якої суми протилежних сторін рівні.<br>III. Існує трапеція, у якої суми протилежних кутів рівні.<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Скільки всього цілих чисел містить проміжок [\\(-1\\); \\(\\log_{4}16\\)]?<br><br>',
    image: null,
    variants: [
      { text: '\\(2\\)', image: null },
      { text: '\\(3\\)', image: null },
  ...
  {
    text: 'Укажіть графік непарної функції.<br><br>',
    image: null,
    variants: [
      { text: ' ', image: image_1805_9_1 },
      { text: ' ', image: image_1805_9_2 },
      { text: ' ', image: image_1805_9_3 },
      { text: ' ', image: image_1805_9_4 },
      { text: ' ', image: image_1805_9_5 }
    ],
    variantImage: testImage
  },
  {
    text: 'Комп’ютерна програма видаляє у п’ятицифровому числі одну цифру навмання. Яка ймовірність того, що в числі \\(37281\\) буде видалено цифру \\(1\\) або цифру \\(2\\)?<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Визначте об’єм правильної чотирикутної піраміди, площа основи якої дорівнює \\(36\\) \\(см^{2}\\), а висота дорівнює стороні основи.<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'Розв’яжіть нерівність \\(x^2\\) + 2\\(x\\) – 15 \\(\\geqslant\\) 0.<br><br>',
    image: null,
    variants: [
  ...
  {
    text: 'В арифметичній прогресії (\\(a_{n}\\)) перший член \\(a_{1}\\) = \\(18,5\\), різниця \\(d\\) = \\(-2,5\\). Скільки всього додатних членів має ця прогресія?<br><br>',
    image: null,
    variants: [
      { text: '\\(6\\)', image: null },
      { text: '\\(7\\)', image: null},
  ...
  {
    text: 'Укажіть проміжок, якому належить корінь рівняння \\(4^x\\cdot5^x=\\frac{1}{400}\\).<br><br>',
    image: null,
    variants: [
  ...
  },
  {
    ...
    leftTitle: '\\(Відрізок\\)<br><br>',        // <-- нове поле
    rightTitle: '\\(Довжина\\) \\(відрізка\\)<br><br>',         // <-- нове поле
    image: image_1805_17,
    leftOptions: [
      { text: 'діаметр круга' },
  ...
  {
    text: 'На діаграмі відображено результати опитування \\(100\\) клієнтів, які ставили оцінки від \\(1\\) до \\(5\\). Середня оцінка склала \\(4,2\\) бали. За відгуками тих відвідувачів, які оцінили роботу від \\(1\\) до \\(4\\) включно, середня оцінка \\(2,5\\) бали. Скільки людей поставили оцінку «\\(5\\)»?',
    type: 'input',
    image: image_1805_21,
  },
  {
